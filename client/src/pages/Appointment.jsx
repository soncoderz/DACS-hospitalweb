...
const Appointment = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      setCurrentStep(6); // Move to success step (step 6) after submission
    }, 1500);
  };
  ...
  const isStepValid = () => {
    switch (currentStep) {
      case 1:
        return formData.branchId && formData.departmentId;
      case 2:
      ...
      case 1:
        return (
          <div className="appointment-step">
            <h2 className="step-title">Chọn Chi Nhánh và Chuyên Khoa</h2>
              ...
              <div className="doctors-grid">
                {filteredDoctors.length > 0 ? (
                  ...
                  <div className="no-results">
                    <p>Không có bác sĩ nào phù hợp với chi nhánh và chuyên khoa đã chọn</p>
                  </div>
                )}
              </div>
            </div>
  ...
  const renderProgress = () => {
    const steps = [
      { number: 1, name: 'Chọn Chuyên Khoa' },
      { number: 2, name: 'Chọn Bác Sĩ' },
      { number: 3, name: 'Chọn Lịch' },
