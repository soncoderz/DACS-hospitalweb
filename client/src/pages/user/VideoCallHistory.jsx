...
import {
  FaVideo, FaClock, FaCalendar, FaUserMd,
  FaEye, FaHistory, FaFilter, FaFileAlt
} from 'react-icons/fa';
          ...
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-2xl font-bold text-gray-800 flex items-center">
                ...
                Lịch sử cuộc gọi Video của tôi
              </h2>
              <p className="text-gray-600 mt-1">Xem lịch sử các cuộc gọi video với bác sĩ</p>
            </div>
            <button
        ...
        <div className="p-6">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 text-lg">Chưa có lịch sử cuộc gọi</p>
            </div>
          ) : (
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
                        ...
                        {room.appointmentId?.bookingCode && (
                          <div className="flex items-center text-sm text-gray-600">
                            <span className="font-medium">Mã lịch hẹn:</span> {room.appointmentId.bookingCode}
                          </div>
                        )}
                      </div>
                    </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                <h4 className="font-semibold text-gray-700 mb-2">Thông tin bác sĩ</h4>
                <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                  <p><span className="font-medium">Tên:</span> {selectedRoom.doctor?.fullName || 'N/A'}</p>
                  <p><span className="font-medium">Email:</span> {selectedRoom.doctor?.email || 'N/A'}</p>
                  {selectedRoom.doctor?.phoneNumber && (
                    <p><span className="font-medium">Số điện thoại:</span> {selectedRoom.doctor.phoneNumber}</p>
                  )}
                </div>
              </div>
              ...
              {selectedRoom.participants && selectedRoom.participants.length > 0 && (
                <div>
                  <h4 className="font-semibold text-gray-700 mb-2">Danh sách tham gia ({selectedRoom.participants.length})</h4>
                  <div className="bg-gray-50 p-4 rounded-lg space-y-2">
