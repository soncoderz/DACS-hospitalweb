        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-1">Xem lịch sử các cuộc gọi video với bệnh nhân</p>
            </div>
            <button
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                  <p><span className="font-medium">Tên:</span> {selectedRoom.patient?.fullName || 'N/A'}</p>
                  <p><span className="font-medium">Email:</span> {selectedRoom.patient?.email || 'N/A'}</p>
                  {selectedRoom.patient?.phoneNumber && (
                    <p><span className="font-medium">Số điện thoại:</span> {selectedRoom.patient.phoneNumber}</p>
                  )}
                </div>
              </div>
